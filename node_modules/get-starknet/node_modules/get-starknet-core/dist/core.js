...
var Y = (t, e, n) => (Z(t, typeof e != "symbol" ? e + "" : e, n), n), Q = (t, e, n) => {
  if (!e.has(t))
    throw TypeError("Cannot " + n);
};
var E = (t, e, n) => (Q(t, e, "read from private field"), n ? n.call(t) : e.get(t)), L = (t, e, n) => {
  if (e.has(t))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t) : e.set(t, n);
}, R = (t, e, n, r) => (Q(t, e, "write to private field"), r ? r.call(t, n) : e.set(t, n), n);
var U = (t, e, n) => (Q(t, e, "access private method"), n);
...
const wallets = [
  ...
  },
  {
    ...
    downloads: {
      ...
      ios: `https://link.braavos.app/dapp/${(W = ssrSafeWindow == null ? void 0 : ssrSafeWindow.location) == null ? void 0 : W.host}`,
...
class LocalStorageWrapper {
  constructor(e) {
    ...
    L(this, x, void 0);
    Y(this, "value");
    R(this, x, e), U(this, C, G).call(this);
  }
  set(e) {
    return !E(this, v) && !U(this, C, G).call(this) ? !1 : (this.delete(), this.value = e, e && (R(this, j, `${E(this, x)}-${generateUID()}`), localStorage.setItem(E(this, j), e)), !0);
  }
  get() {
    return U(this, H, V).call(this), this.value;
  }
  delete() {
    return !E(this, v) && !U(this, C, G).call(this) ? !1 : (this.value = null, E(this, j) && localStorage.removeItem(E(this, j)), !0);
  }
}
v = new WeakMap(), j = new WeakMap(), x = new WeakMap(), H = new WeakSet(), V = function() {
  this.value && this.set(this.value);
}, C = new WeakSet(), G = function() {
  try {
    !E(this, v) && typeof window < "u" && (R(this, j, Object.keys(localStorage).find(
      (e) => e.startsWith(E(this, x))
    )), R(this, v, !0), E(this, j) && this.set(localStorage.getItem(E(this, j))));
  } catch (e) {
    console.warn(e);
  }
  return E(this, v);
...
function setGlobalDefaultVal(t) {
  ...
  var g;
  (g = (i = t.__FEDERATION__).__PRELOADED_MAP__) != null || (i.__PRELOADED_MAP__ = /* @__PURE__ */ new Map());
}
...
function parseHyphen(t) {
  return t.replace(parseRegex(hyphenRange), (e, n, r, o, s, i, a, l, c, u, d, g) => (isXVersion(r) ? n = "" : isXVersion(o) ? n = `>=${r}.0.0` : isXVersion(s) ? n = `>=${r}.${o}.0` : n = `>=${n}`, isXVersion(c) ? l = "" : isXVersion(u) ? l = `<${Number(c) + 1}.0.0-0` : isXVersion(d) ? l = `<${c}.${Number(u) + 1}.0-0` : g ? l = `<=${c}.${u}.${d}-${g}` : l = `<=${l}`, `${n} ${l}`.trim()));
}
...
function satisfy(t, e) {
  if (!t)
    return !1;
  const o = parseRange(e).split(" ").map((g) => parseComparatorString(g)).join(" ").split(/\s+/).map((g) => parseGTE0(g)), s = extractComparator(t);
  if (!s)
    return !1;
  const [, i, , a, l, c, u] = s, d = {
    operator: i,
  ...
  for (const g of o) {
    const M = extractComparator(g);
    if (!M)
      return !1;
    const [, y, , A, h, I, w] = M, p = {
      operator: y,
      version: combineVersion(A, h, I, w),
      major: A,
      minor: h,
      patch: I,
...
function getRegisteredShare(t, e, n, r) {
  ...
  for (const l of a)
    if (o && t[l] && t[l][e]) {
      const { requiredVersion: c } = o, d = getFindShareFunction(i)(t, l, e), g = () => {
        if (o.singleton) {
          if (typeof c == "string" && !satisfy(d, c)) {
            const A = `Version ${d} from ${d && t[l][e][d].from} of shared singleton module ${e} does not satisfy the requirement of ${n.from} which needs ${c})`;
          ...
          if (c === !1 || c === "*" || satisfy(d, c))
            return t[l][e][d];
          for (const [A, h] of Object.entries(t[l][e]))
            if (satisfy(A, c))
              return h;
        }
      }, M = {
...
function generateSnapshotFromManifest(t) {
  ...
  if (!Object.keys(s).length) {
    var M;
    g = ((M = t.remotes) === null || M === void 0 ? void 0 : M.reduce(function(m, k) {
      var B, F = k.federationContainerName;
      return d.includes(F) ? B = a[F] : "version" in k ? B = k.version : B = k.entry, m[F] = {
        matchedVersion: B
      }, m;
    }, {})) || {};
  }
  Object.keys(s).forEach(function(m) {
    return g[m] = {
      matchedVersion: d.includes(m) ? a[m] : s[m]
    };
  });
  var y = t.metaData, A = y.remoteEntry, h = A.path, I = A.name, w = A.type, p = y.types, O = y.buildInfo.buildVersion, z = y.globalName, T = t.exposes, S = {
    version: l || "",
    buildVersion: O,
    globalName: z,
    remoteEntry: simpleJoinRemoteEntry(h, I),
    remoteEntryType: w,
    remoteTypes: simpleJoinRemoteEntry(p.path, p.name),
    remoteTypesZip: p.zip || "",
    remoteTypesAPI: p.api || "",
    remotesInfo: g,
    shared: t == null ? void 0 : t.shared.map(function(m) {
      return {
        assets: m.assets,
        sharedName: m.name
      };
    }),
    modules: T == null ? void 0 : T.map(function(m) {
      return {
        moduleName: m.name,
        modulePath: m.path,
        assets: m.assets
  ...
  if (!((n = t.metaData) === null || n === void 0) && n.prefetchInterface) {
    ...
    S = _object_spread_props(_object_spread$1({}, S), {
      prefetchInterface: _
    });
  }
  if (!((r = t.metaData) === null || r === void 0) && r.prefetchEntry) {
    var D = t.metaData.prefetchEntry, b = D.path, N = D.name, P = D.type;
    S = _object_spread_props(_object_spread$1({}, S), {
      prefetchEntry: simpleJoinRemoteEntry(b, N),
      prefetchEntryType: P
    });
  }
  return "publicPath" in t.metaData ? c = _object_spread_props(_object_spread$1({}, S), {
    publicPath: u()
  }) : c = _object_spread_props(_object_spread$1({}, S), {
    getPublicPath: u()
  }), c;
}
...
function createScript(t, e, n, r) {
  ...
  n && Object.keys(n).forEach(function(g) {
    o && (g === "async" || g === "defer" ? o[g] = n[g] : o.setAttribute(g, n[g]));
  });
  var d = function(g, M) {
...
function createLink(t, e) {
  ...
  return o.onerror = g.bind(null, o.onerror), o.onload = g.bind(null, o.onload), {
    link: o,
    needAttach: s
  };
}
 ...
 ${safeToString$1(this.remoteInfo)}`), this.remoteEntryExports = e, this.remoteEntryExports;
  ...
  async get(e, n) {
    ...
    if (!this.inited) {
      ...
      await o.init(g.shareScope, g.initScope, g.remoteEntryInitOptions), await this.host.hooks.lifecycle.initContainer.emit(_extends$4({}, g, {
  ...
  if (l && !isManifestProvider(l) && (n(l, e, r), l.remotesInfo)) {
    ...
    for (const u of c) {
      if (o[u])
        continue;
      o[u] = !0;
      const d = splitId(u), g = l.remotesInfo[u];
...
function generatePreloadAssets(t, e, n, r, o) {
  const s = [], i = [], a = [], l = /* @__PURE__ */ new Set(), c = /* @__PURE__ */ new Set(), { options: u } = t, { preloadConfig: d } = e, { depsRemote: g } = d;
  traverseModuleInfo(r, n, (h, I, w) => {
    let p;
    if (w)
      p = d;
    else if (Array.isArray(g)) {
      const D = g.find((b) => b.nameOrAlias === I.name || b.nameOrAlias === I.alias);
      if (!D)
        return;
      p = defaultPreloadArgs(D);
    } else if (g === !0)
      p = d;
    else
      return;
    const O = getResourceUrl(h, "remoteEntry" in h ? h.remoteEntry : "");
    O && a.push({
      name: I.name,
      moduleInfo: {
        name: I.name,
        ...
        entryGlobalName: "globalName" in h ? h.globalName : I.name,
        shareScope: "",
        version: "version" in h ? h.version : void 0
      },
      url: O
    });
    let z = "modules" in h ? h.modules : [];
    const T = normalizePreloadExposes(p.exposes);
    if (T.length && "modules" in h) {
      var S;
      z = h == null || (S = h.modules) == null ? void 0 : S.reduce((D, b) => ((T == null ? void 0 : T.indexOf(b.moduleName)) !== -1 && D.push(b), D), []);
    }
    function _(D) {
      const b = D.map((N) => getResourceUrl(h, N));
      return p.filter ? b.filter(p.filter) : b;
    }
    if (z) {
      const D = z.length;
      for (let b = 0; b < D; b++) {
        const N = z[b], P = `${I.name}/${N.moduleName}`;
        t.hooks.lifecycle.handlePreloadModule.emit({
          id: N.moduleName === "." ? I.name : P,
          name: I.name,
          remoteSnapshot: h,
          preloadConfig: p,
          remote: I,
          origin: t
        }), !getPreloaded(P) && (p.resourceCategory === "all" ? (s.push(..._(N.assets.css.async)), s.push(..._(N.assets.css.sync)), i.push(..._(N.assets.js.async)), i.push(..._(N.assets.js.sync))) : (p.resourceCategory = "sync") && (s.push(..._(N.assets.css.sync)), i.push(..._(N.assets.js.sync))), setPreloaded(P));
      }
    }
  }, !0, {}, o), o.shared && o.shared.forEach((h) => {
    var I;
    const w = (I = u.shared) == null ? void 0 : I[h.sharedName];
    if (!w)
      return;
    const p = getRegisteredShare(t.shareScopeMap, h.sharedName, w, t.hooks.lifecycle.resolveShare);
    p && typeof p.lib == "function" && (h.assets.js.sync.forEach((O) => {
      l.add(O);
    }), h.assets.css.sync.forEach((O) => {
      c.add(O);
    }));
  });
  const y = i.filter((h) => !l.has(h));
  return {
    cssAssets: s.filter((h) => !c.has(h)),
...
class FederationHost {
  ...
  async loadShare(e, n) {
    ...
    if (a && a.loading && !a.loaded) {
      ...
      const u = (async () => {
        ...
        const g = getRegisteredShare(this.shareScopeMap, e, i, this.hooks.lifecycle.resolveShare);
        return g && (g.lib = d, g.loaded = !0), d;
      })();
  ...
  async loadRemote(e, n) {
    try {
      const { loadFactory: r = !0 } = n || {
        loadFactory: !0
      }, { module: o, moduleOptions: s, remoteMatchInfo: i } = await this._getRemoteModuleAndOptions(e), { pkgNameOrAlias: a, remote: l, expose: c, id: u } = i, d = await o.get(c, n), g = await this.hooks.lifecycle.onLoad.emit({
        id: u,
        pkgNameOrAlias: a,
        expose: c,
  ...
  initializeSharing(e = DEFAULT_SCOPE, n) {
    ...
    const s = r[e], i = (u, d) => {
      ...
      s[u] = s[u] || {};
      const A = s[u], h = A[M], I = Boolean(h && (h.eager || ((g = h.shareConfig) == null ? void 0 : g.eager)));
      (!h || h.strategy !== "loaded-first" && !h.loaded && (Boolean(!y) !== !I ? y : o > h.from)) && (A[M] = d);
    }, a = [], l = (u) => u && u.init && u.init(r[e]), c = async (u) => {
      const { module: d } = await this._getRemoteModuleAndOptions(u);
      if (d.getEntry) {
        const g = await d.getEntry();
        d.inited || (l(g), d.inited = !0);
      }
    };
  ...
  formatOptions(e, n) {
    const r = formatShareConfigs(n.shared || {}, n.name), o = _extends({}, e.shared, r), { userOptions: s, options: i } = this.hooks.lifecycle.beforeInit.emit({
      ...
      options: e,
      shareInfo: o
    }), l = (s.remotes || []).reduce((g, M) => (this.registerRemote(M, g, {
      force: !1
    }), g), i.remotes);
    Object.keys(r).forEach((g) => {
      const M = r[g];
      !getRegisteredShare(this.shareScopeMap, g, M, this.hooks.lifecycle.resolveShare) && M && M.lib && this.setShared({
        pkgName: g,
        lib: M.lib,
        get: M.get,
        loaded: !0,
  ...
  setShared({ pkgName: e, shared: n, from: r, lib: o, loading: s, loaded: i, get: a }) {
    ...
    (Array.isArray(c) ? c : [
      ...
      this.shareScopeMap[g] || (this.shareScopeMap[g] = {}), this.shareScopeMap[g][e] || (this.shareScopeMap[g][e] = {}), !this.shareScopeMap[g][e][l] && (this.shareScopeMap[g][e][l] = _extends({
        version: l,
        scope: [
          "default"
        ]
        ...
        loaded: i,
        loading: s
      }), a && (this.shareScopeMap[g][e][l].get = a));
    });
  }
  removeRemote(e) {
